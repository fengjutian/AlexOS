...
<div class="alex-grid">
  ...
  <a class="alex-card" href="release-gates"><span class="alex-card__icon">GA</span><strong>检查发布门禁</strong><span>兼容、安全、迁移、性能、AI Eval 与供应链 evidence。</span></a>
...
[`docs/reverse-ipc.md`](reverse-ipc.md)。
...
基线与测试进度见 [`docs/status.md`](status.md)。CI 配置见
